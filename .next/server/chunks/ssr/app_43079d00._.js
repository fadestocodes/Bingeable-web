...
const useGetSingleUser = (params)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const getSingleUser = async ()=>{
            try {
                setLoading(true);
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`${("TURBOPACK compile-time value", "http://localhost:3000/api")}/user`, {
                    method: 'POST',
                    headers: {
...
function UserAdminPage({ params }) {
    ...
    const { data, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$user$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetSingleUser"])({
        id: Number(userId)
    });
...
//# sourceMappingURL=app_43079d00._.js.map