...
const useGetUser = ()=>{
    ...
    const getUser = async ()=>{
        ...
        if (user) return user;
        const accessToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$accessTokenStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccessToken"])();
        if (!accessToken) {
            return null;
        }
...
const grantStatus = async (data)=>{
    try {
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`${("TURBOPACK compile-time value", "http://192.168.1.65:3000/api")}/admin/grant-status`, {
            method: 'PATCH',
            headers: {
                'Content-type': 'application/json'
            },
...
const AdminPage = ()=>{
    ...
    const handleSubmit = async ()=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginLocal"])();
    };
...
//# sourceMappingURL=app_e86a9af4._.js.map